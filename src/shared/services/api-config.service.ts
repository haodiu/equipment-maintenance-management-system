...
export class ApiConfigService {
  ...
  get imageKitConfig() {
    return {
      publicKey: this.getString('IMAGEKIT_PUBLIC_KEY'),
      privateKey: this.getString('IMAGEKIT_PRIVATE_KEY'),
      baseURL: this.getString('IMAGEKIT_BASE_URL'),
      imageKitId: this.getString('IMAGEKIT_ID'),
    };
  }
}
